...
Registro de distancia recorrida (KM)
...
Esta aplicación tiene fines educativos y demostrativos.
No representa una herramienta oficial de la Policía de la Ciudad.
...
💡 Feedback rápido (importante)

Tu README original estaba bien, pero:

❌ Mezclaba texto sin estructura
❌ Tenía errores de redacción
❌ No era visualmente escaneable
❌ No parecía proyecto profesional
...
✅ Es visual
✅ Tiene jerarquía
✅ Es ideal para portfolio / CV

Si querés, en el siguiente paso 
te lo dejo nivel TOP recruiter con:

badges (estado, versión, etc.)
gif animado de la app
sección “arquitectura” (MVVM bien explicado)
link para descargar APK

Eso ya te pone por encima del 90% de devs 👀

no pongas badges ni gif , pone las tecnologias usadas , authentication de firebase, firestore para db , mvvm , test , foreground service  de location, permisos correspondiente , hilt , jetpack compose  y por ultimo poneme el link para descargar la apk

Perfecto, te lo dejo ajustado a lo que pediste: profesional, sin badges ni gifs, con tecnologías bien detalladas y listo para agregar el APK 👇
